@php
    ...
    $defaults = [
        ...
        'unit_sarpras'   => old('unit_sarpras', $barang->unit_sarpras ?? 'atas'),
        'tipe_transaksi' => old('tipe_transaksi', $barang->tipe_transaksi ?? 'pinjam'),
...
<div class="row g-3">
    <div class="col-md-4">
        ...
        <input type="text" id="{{ $prefix }}_kode_barang" name="kode_barang"
            class="form-control" value="{{ $defaults['kode_barang'] }}" required>
    </div>
    <div class="col-md-8">
        <label for="{{ $prefix }}_nama" class="form-label">Nama Barang</label>
        <input type="text" id="{{ $prefix }}_nama" name="nama"
            class="form-control" value="{{ $defaults['nama'] }}" required>
    </div>
    ...
    <div class="col-md-6">
        ...
        <input type="text" id="{{ $prefix }}_kategori" name="kategori"
            class="form-control" value="{{ $defaults['kategori'] }}" placeholder="Contoh: ATK, Elektronik">
    </div>
    <div class="col-md-6">
        <label for="{{ $prefix }}_lokasi" class="form-label">Lokasi Penyimpanan</label>
        <input type="text" id="{{ $prefix }}_lokasi" name="lokasi"
            class="form-control" value="{{ $defaults['lokasi'] }}" placeholder="Contoh: Sarpras Atas - Lemari AV">
    </div>

    <div class="col-md-4">
        <label for="{{ $prefix }}_stok_total" class="form-label">Stok Total</label>
        <input type="number" id="{{ $prefix }}_stok_total" name="stok_total"
            class="form-control" min="0" value="{{ $defaults['stok_total'] }}" required>
    </div>
    <div class="col-md-4">
        <label for="{{ $prefix }}_stok_tersedia" class="form-label">Stok Tersedia</label>
        <input type="number" id="{{ $prefix }}_stok_tersedia" name="stok_tersedia"
            class="form-control" min="0" value="{{ $defaults['stok_tersedia'] }}" required>
    </div>
    <div class="col-md-4">
        <label for="{{ $prefix }}_stok_rusak" class="form-label">Stok Rusak</label>
        <input type="number" id="{{ $prefix }}_stok_rusak" name="stok_rusak"
            class="form-control" min="0" value="{{ $defaults['stok_rusak'] }}" required>
    </div>
